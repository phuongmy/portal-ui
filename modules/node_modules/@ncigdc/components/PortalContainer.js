...
const SkipLink = styled.a({ position: 'absolute', left: '-999px', backgroundColor: 'black', zIndex: 1000 });
...
const enhance = compose(
  ...
  lifecycle({
    componentDidMount(): void {
      ...
      this.removeListen = this.props.listen(() => window.scrollTo(0, 0));
    },
...
const PortalContainer = ({ notifications }: { notifications: Array<{ dismissed: string }> }) => (
